...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pecos-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13727&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pecos-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pecos` can be installed with:

```
conda install pecos
```

It is possible to list all of the versions of `pecos` available on your platform with:
